    ...
    <v-flex class="text-center">
      <v-card :flat="type === 'dialog'">
        <v-card-text :class="{'pa-0 ': type === 'dialog'}" style="max-width: 960px;">
          ...
          in Bezug auf Ihre Daten haben. Verantwortlich für die Verarbeitung von personenbezogenen Daten auf dieser Website
          ist (vgl.
          ...
          <p>
            ...
            um Ihnen unsere Website anzeigen zu können. Soweit davon personenbezogene Daten betroffen sind, ist Art. 6 Abs.
            1 lit. f DSGVO Rechtsgrundlage für die Erhebung.
          </p>
          ...
          <p>
            ...
            Ihres Webbrowsers löschen. Sie können auch die Einstellungen Ihres Webbrowsers so anpassen, dass keine Cookies
            gespeichert werden. Dann sind unter Umständen nicht alle Funktionen unserer Website verfügbar.
          </p>
          ...
          <p>
            ...
            b DSGVO zusätzliche Rechtsgrundlage. Die Daten verwenden wir ausschließlich, um Ihre Anfrage zu bearbeiten und
            zu beantworten.
          </p>
          ...
          <p>
            ...
            Ihre Registrierung der Vorbereitung eines Vertragsabschlusses ist Art. 6 Abs. 1 lit. b DSGVO zusätzliche Rechtsgrundlage.Ihre
            Registrierung ist für die Nutzung bestimmter Inhalte und Leistungen auf unserer Website erforderlich bzw. für
            die Erfüllung eines Vertrags oder zur Durchführung vorvertraglicher Maßnahmen erforderlich.
          </p>
          ...
          <p>
            ...
            Daten, die Sie in die Eingabemaske eingeben (z.B. Nachname, Vorname, E-Mail-Adresse). Eine Weitergabe an Dritte
            findet nicht statt. Rechtsgrundlage für die Verarbeitung ist im Falle einer Einwilligung Art. 6 Abs. 1 lit. a
            DSGVO. Die Erhebung der Daten dient der Durchsetzung unserer Kommentierungs-Regeln.
          </p>
          ...
          <p>
            ...
            hinaus gesetzliche Pflichten zur Speicherung bestehen, sperren oder löschen wir Ihre Daten mit Ablauf der gesetzlichen
            Speicherfristen.
          </p>
          ...
          <p>
            ...
            <ol class="pl-3 pr-2">
              <li>
                ...
                Daten verarbeiten, die Sie betreffen. Ist dies der Fall, so haben Sie das Recht auf Auskunft über diese personenbezogenen
                Daten sowie auf weitere Informationen, z.B. die Verarbeitungszwecke, die Empfänger und die geplante Dauer
                der Speicherung bzw. die Kriterien für die Festlegung der Dauer.
              </li>
              <li>
              ...
              <li>
                ...
                sie Ihre datenschutzrechtliche Einwilligungserklärung widerrufen haben oder die Daten unrechtmäßig verarbeitet
                wurden.
              </li>
              <li>
                Auskunftsrecht
              ...
              <li>
                ...
                Im Falle von Direktwerbung haben Sie als betroffene Person das Recht, jederzeit Widerspruch gegen die Verarbeitung
                Sie betreffender personenbezogener Daten zum Zwecke derartiger Werbung einzulegen; dies gilt auch für das
                Profiling, soweit es mit solcher Direktwerbung in Verbindung steht.
              </li>
              <li>
                Recht auf Widerruf Ihrer datenschutzrechtlichen Einwilligung
                <br> Sie können eine Einwilligung in die Verarbeitung Ihrer personenbezogenen Daten jederzeit mit Wirkung für
